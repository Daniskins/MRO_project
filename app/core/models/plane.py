...
class Plane(Base):
    ...
    serial_number: Mapped[str] = mapped_column(String(20), unique=True)
    tail_number: Mapped[str] = mapped_column(String(20), unique=True)
    ...
    manufacturer_date: Mapped[datetime] = mapped_column(Date) #Дата выпуска самолета